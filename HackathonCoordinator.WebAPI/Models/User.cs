...
public partial class User
{
    ...
    public virtual ICollection<Result> ResultCreatedBies { get; set; } = new List<Result>();

    public virtual ICollection<Result> ResultUpdatedBies { get; set; } = new List<Result>();
