...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "HackathonCoordinator API v1");
...
app.MapGet("/health", async (HackathonCoordinatorContext dbContext) =>
{
    try
    {
...
{
    var dbContext = scope.ServiceProvider.GetRequiredService<HackathonCoordinatorContext>();
